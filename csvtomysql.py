...
def main(input_file, user, password, host, table, database, max_inserts=10000):
    ...
    print 'Committing rows to database ... Ket khuc roi ... I love you!'
    db.commit()
    print 'Done!'
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Automatically insert CSV contents into MySQL - Khanhnn')
